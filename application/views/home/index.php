                    ...
                    <div class="row mt-3 mb-4">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 text-center mt-2">
                            <div class="avatar-md m-auto">
                               ...
                               <div class="c-gray">
                                <h4>Secured</h4>
                                <p>Fast and secure, Shortly uses HTTPS protocol and data encryption. Also, Shortly uses Google Safe browsing to check every submitted URL is not malicious.</p>
                            </div>
                        </div>
