...
class Account extends CI_Controller {
    ...
    public function accountRegistration(){
       ...
       public function getUserList() {
        ...
        // Pagination Configuration
        $config['base_url'] = base_url('api/v1/account/_users_list');
        $config['use_page_numbers'] = TRUE;
        $config['total_rows'] = $all_count;
        $config['per_page'] = $row_per_page;
        // Pagination with bootstrap
    ...
    public function getActivityLogs() {
        ...
        // All records count
        $all_count = $this->Account_model->getActivityLogsCount();
        // Get records
        $result = $this->Account_model->getActivityLogs($row_per_page, $row_no);
        // Pagination Configuration
        $config['base_url'] = base_url('api/v1/account/_activity_logs');
        $config['use_page_numbers'] = TRUE;
        $config['total_rows'] = $all_count;
        $config['per_page'] = $row_per_page;
        // Pagination with bootstrap
